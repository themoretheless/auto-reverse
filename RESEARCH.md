...
4. [Next R11-R12] Зафиксировать latency budget и собрать matrix реальных
   устройств, частот событий и приложений.
...
Пакеты 1-2 (`R01-R10`) реализованы без изменения live scroll policy:
trace/replay/lab, ScrollTest-style benchmark, observed rates и public interval
tap latency. Следующий пакет - `R11-R15`: latency budget, physical matrix,
измеримый smooth-scrolling contract, presets и pure dynamics boundary.
