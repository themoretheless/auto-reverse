...
- `DESIGN.md`, `QA.md`, `PRIVACY.md`, `SECURITY.md`, `RELEASE.md`, `CONTRIBUTING.md` - отдельные контракты вместо смешивания release/design требований с architecture narrative; `RELEASE.md` является единственным полным release checklist.
