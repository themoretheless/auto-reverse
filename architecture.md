...
3. Profiles/UX: optional fields, tri-state direction, aliases и device-state
   ...
   public-state watchdog также завершены. Следующий пакет R56-R60 добавляет
   typed recovery audit, migration/property fixtures и release kill switch.
...
- automatic store migration plus unknown-field preservation fixtures;
...
- import supports legacy v0->v1 review, but automatic store migrations and
  unknown-field preservation fixtures remain R57 work;
- recovery reason/attempt audit, property/fuzz fixtures, platform regression
  matrix and the dynamics release kill switch remain R56-R60 work;
