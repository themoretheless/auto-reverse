...
- `recommendation.md` - 760 пунктов backlog/review (500 базовых + N01-N260 после автозапуска, menu bar, bundle identity и lifecycle/design review) + верифицированные находки итераций ревью.
...
- repeated review fixed the recommendation counter so exactly 500 backlog items are counted (later extended by N01-N260 after startup, menu bar, bundle identity and lifecycle/design review, total 760);
