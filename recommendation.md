# 970 рекомендаций, проблем и улучшений (500 базовых + N01-N400 + R01-R60 + S01-S10)

Список обновлен 2026-07-18 после дополнительного анализа 10 популярных macOS utility/input repositories, научных работ по scrolling transfer functions, accuracy и latency, а также официальных Apple/libinput materials. Первые 500 пунктов остаются базовым аудитом, `N01-N400` фиксируют предыдущие implementation/review проходы, `R01-R60` - research-derived backlog, а `S01-S10` - новый завершенный проход по надежности config и честной update policy. Подробные исследовательские источники находятся в `RESEARCH.md`, контракт обновлений - в `UPDATES.md`.
